...
<head>
    ...
    <link href="<?php echo $theme_url ?>/assets/css/animate.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/themify.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/scrollbar.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/magnific-popup.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/swiper.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/cubeportfolio.min.css" rel="stylesheet" type="text/css" />

    <!-- Theme Styles -->
    <link href="<?php echo $theme_url ?>/assets/css/theme.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $theme_url ?>/assets/css/global.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="s-header__navbar-row-col">
                        ...
                        <div class="s-header__logo">
                            <a href="index.html" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="<?php echo $theme_url ?>/assets/images/logo.png" alt="Proboxing Logo">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="<?php echo $theme_url ?>/assets/images/logo-dark.png" " alt="Proboxing Logo">
                                </a>
                        </div>
                        <!-- End Logo -->
                    </div>
