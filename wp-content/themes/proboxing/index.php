...
<div class="js__parallax-window" style="background: url(<?php echo $theme_url ?>/assets/images/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
    <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-margin-b-80--xs">
            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Conoce nuestras promociones</h2>
        </div>
        <a href="#" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">ver más</a>
    </div>
</div>
<!-- End Parallax -->
...
<!-- Subscribe -->
<div class="js__parallax-window" style="background: url(<?php echo $theme_url ?>/assets/images/1920x1080/07.jpg) 50% 0 no-repeat fixed;">
...
<!-- Testimonials -->
<div class="js__parallax-window" style="background: url(<?php echo $theme_url ?>/assets/images/1920x1080/04.jpg) 50% 0 no-repeat fixed;">
    <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
