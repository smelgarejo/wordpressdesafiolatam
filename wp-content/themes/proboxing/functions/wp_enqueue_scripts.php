...
function dl_enqueue_scripts() {
	...
	wp_register_script('jquery', get_theme_file_uri('/assets/js/jquery.min.js'), null, '2.0.0', true);
	wp_register_script('jquery-migrate', get_theme_file_uri('/assets/js/jquery-migrate.min.js'), array('jquery'), '2.0.0', true);
